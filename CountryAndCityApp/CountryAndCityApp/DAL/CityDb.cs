...
namespace CountryAndCityApp.DAL
{
    ...
    public class CityDb
    {
        ...
        {
            string message = "";
            string query = "INSERT INTO tbl_city VALUES ('" + aCity.CityName + "', '" + aCity.CityAbout + "', '" + aCity.NoOfDwellers + "','" + aCity.Location + "','" + aCity.Weather + "','" + aCity.CountryId + "')";
            SqlConnection connection = new SqlConnection(connectionString);
            SqlCommand command = new SqlCommand(query, connection);
            connection.Open();
            command.ExecuteNonQuery();
            connection.Close();
            message = "City: " + aCity.CityName + " has been saved";
            return message;
        }

        public int CityExits(string cityName)
        {
            int rowAffected = 0;
        ...
        public List<City> GetAllCities()
        {
           ...
           // string query = "SELECT * FROM tbl_city";
            ...
            while (aReader.Read())
            {
                ...
                //aCity.CountryName = CountryName(CountryId);
